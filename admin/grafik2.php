           ...
           <li>
            ...
            <a  href="Registeruser.php">
              ...
              <span>Registrasi User</span>
               ...
               <li>
            <a class="active" href="grafik.php">
      ...
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          <div class="col-lg-12">
           ...
           include 'conn.php';
$id = $_GET['id_grafik'];
$posisi  = mysqli_query($conn, "select * from tbl_grafik where id_grafik ='$id'");
$row        = mysqli_fetch_array($posisi);
?>
<!DOCTYPE html>
<html>

<body>
<form method="post" action="updategrafik.php?id_grafik=<?= $row['id_grafik'];?>" enctype="multipart/form-data">
<tr><td>Total</td><br><br><td>:</td><td><input type="text" value="<?php echo $row['total'];?>" name="total" required></td>
<br><br>
<td>Jabatan</td><br><br><td></td><td><input type="text" value="<?php echo $row['posisi'];?>" name="posisi"  required></td></tr> 
</table>
<br><br>
<button type="submit" name="simpan" class="btn btn-theme" value="simpan">SIMPAN PERUBAHAN</button>
        </form>
    </body>
</html>
</div>
