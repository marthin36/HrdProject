        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel"  style="height:580px">
              ...
              <form class="form-horizontal style-form" method="post" action="pengumumanproses.php">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Judul</label>
                  <div class="col-sm-10">
                    <input type="text" name="juduls" class="form-control" required>
                  </div>
                  <br><br><br><br>
                </div>
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="deskripsis" class="form-control" required></textarea>
