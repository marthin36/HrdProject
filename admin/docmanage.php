...
<body>
 ...
 -->         <center><img src="img/<?php echo $query2['pas_photo']; ?>" width="100px;" style="border: 5px;padding-top: 0px;border-radius: 20px"/> 
    ...
    <li class="mt">
          ...
          <li>
            <a class="active" href="daftarkontrakan.php">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Daftar Kontrak Sewa Rumah</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Form Elements</h4>
                  <!-- <form class="form-horizontal style-form" method="post" action="tambahkategori.php">
                              <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Masukkan Kategori Baru</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <button class="btn btn-primary"  type="submit" name="tambahkategori"> Tambah</button>
                   <button class="btn btn-danger"  type="reset" name="save"> Batal</button>	  
            </div>
              ...
              <form class="form-horizontal style-form" method="post" action="docmanageprocess.php"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Masukkan Nama</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" required>
                  </div>
                </div>
                   <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Luas Rumah/Kamar</label>
                  <div class="col-sm-10">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Awal Waktu Kontrak</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="awal" required>
                  </div>
                </div>
                    <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Akhir Waktu Kontrak</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="akhir" required>
                  </div>
                </div>
                 <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Masukkan File</label>
                  <div class="col-sm-10">
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Kelompok 3 </strong>
        </p>
        <div class="credits">
          <!--
