...
<button onclick="window.location.href = 'uploaddoc2.php'"   class="btn btn-primary" name="submit"><span class="fa fa-list"></span> Tampilkan Upload User</button>
<br><br>
  <table id="example" class="display responsive nowrap" style="width:100%">
    ...
    <tbody class="alert-success">
      ...
      $row = $conn->query("SELECT * FROM `file` WHERE role = 1 AND id_user = '$id'") or die(mysqli_error());
