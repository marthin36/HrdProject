            ...
            <div class="col-lg-12">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                       ...
                       <tr>  <th>Nama</th><td><?=$items['nama'];?></td>
                        </tr>
                        
                       
                        <tr> <th>tujuan</th><td><?=$items['tujuan'];?></td></tr>

                        <tr>        <th>Alasan</th><td><?=$items['alasan'];?></td></tr>
                        <tr>
                        <th>Mulai Cuti</th><td><?=$items['mulaicuti'];?></td></tr>
                        <tr><th>Selesai Cuti</th><td><?=$items['selesaicuti'];?></td></tr>
                ...
                <?php } ?>
                       <tr>
                        ...
                        <td>
                            <form action="berinotifikasi.php?id_cuti=<?=$id_cuti;?>" method="post">
                            <select class="form-control" name="ajukan">
                                <option>-----</option>
                                <option style="color: green;">Di setujui</option>
