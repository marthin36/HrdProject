 ...
 -->         <center><img src="img/<?php echo $query2['pas_photo']; ?>" width="100px;" style="border: 5px;padding-top: 0px;border-radius: 20px"/> 
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <div class="form-panel" style="height:1000px">

        <h3><i class="fa fa-angle-right"></i> Detail Pengumuman</h3>
        <hr>
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="container">	
				...
				$idPengumuman= $_GET['id_pengumuman'];
		              $query = "SELECT * FROM pengumuman WHERE id_pengumuman=$idPengumuman";
		              $pengumuman = mysqli_query($conn, $query);
		              while($pengumumans = mysqli_fetch_array($pengumuman)){
		           ?>
                	<a href="perbaruipengumuman.php?id_pengumuman=<?=$pengumumans['id_pengumuman']?>"><button class="btn btn-warning"><span class="glyphicon glyphicon-wrench"> <b>Perbarui</b></span></button></a>
					<div class="col-sm-5">
						<br><br><br><br>
						<table class="table table-hover">
							<tr>
								<th>Id</th>
								<td><?=$pengumumans['id_pengumuman']?></td>
							</tr>
							<tr>
								<th>Judul </th>
