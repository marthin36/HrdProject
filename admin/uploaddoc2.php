...
<head>
  ...
  <title>Sistem HRD || Atur Dokumen</title>
 ...
 -->         <center><img src="img/<?php echo $query2['pas_photo']; ?>" width="100px;" style="border: 5px;padding-top: 0px;border-radius: 20px"/> 
           ...
           <li>
            ...
            <a class="active"  href="docmanage.php">
              ...
              <ul class="sub">
                ...
                <li><a href="bagiandoc.php">Upload File</a></li>
            </ul>
          </li>
           <li>
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i>Kelola Document User </h3>
        <div class="row mt">
          <div class="col-lg-5">
            <!-- <p>Place your content here.</p> -->
                    <div class="container">
                    <?php
                    require_once('bagiandoc2.php');
                    ?>
                    </div>   
                    <br>
                     <!-- <?php
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Kelompok PA 2 2019</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
