 ...
 -->         <center><img src="image/profil/<?php echo $query2['pas_photo']; ?>" width="100px;" style="border: 5px;padding-top: 0px;border-radius: 20px"/> 
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
                     <h3><i class="fa fa-angle-right"></i> Form Register User</h3>
              <h4 class="mb"><i class="fa fa-angle-right"></i> </h4>
              <form class="form-horizontal style-form" method="post" action="registeruserproses.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="radio" class="" name="jenis" value="Pria" width="20px" required> Pria
                    <input type="radio" class="" name="jenis" value="Wanita" required> Wanita
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Alamat</label>
                  <div class="col-sm-10">
                    <input class="form-control" placeholder="Masukkan alamat" type="text" name="alamat" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Nomor Telepon</label>
                  <div class="col-sm-10">
                    <input class="form-control"  type="text" placeholder="Masukkan No Telepon" name="notelp" required >
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" placeholder="Masukkan NIP" name="nip" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">NIDN</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" placeholder="Masukkan NIDN" name="nidn" required >
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Agama</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="agama" placeholder="placeholder" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="noktp" placeholder="Masukkan No KTP" required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">No SK Kepangkatan</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nosk" placeholder="placeholder" required>
                  </div>
                </div>
                 <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="" name="kerja" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                   <label class="col-sm-2 col-sm-2 control-label">Masukkan Gambar</label>
                   <br>
                   <div class="col-sm-10">

                     <input type="file" name="gambar" placeholder="masu" accept="image/*" class="login-input" required>
                      <span class="help-block"><i class="fa fa-info"></i> Masukkan gambar dengan format jpg</span>
                     <br><br>
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Kelompok 3 PA</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
