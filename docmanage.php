 ...
 -->         <center><img src="img/<?php echo $query2['pas_photo']; ?>" width="100px;" style="border: 5px;padding-top: 0px;border-radius: 20px"/> 
          ...
          <li class="mt">
           ...
           <li>
            ...
            <li>
            <a class="active" href="docmanage.php">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Insert Data Management</h3>
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Form Elements</h4>
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                  <button class="btn btn-success"  type="submit" name="tambahkategori"> Simpan</button>
              ...
              <form class="form-horizontal style-form" method="post" action="docmanageprocess.php">

                <div class="form-group">
                     <label class="col-sm-2 col-sm-2 control-label">Pilih Kategori</label>
                    <div class="col-sm-7">
                        <select class="btn btn-default dropdown-toggle" data-toggle="dropdown" name="kategori">
                            <option>----Kategori-----</option>
                 			<?php 
			$query2 = "SELECT * FROM kategori";
			$kategori = mysqli_query($conn, $query2);
			while($kategori1 = mysqli_fetch_array($kategori)){ ?>				
				<option><?=$kategori1['kategori']?></option>
            <?php } ?>
