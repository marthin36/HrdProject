...
<head>
  ...
  <title>Table Request Cuti</title>
              ...
              <!-- konfigurasi -->
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    include('conn.php');
                        ...
                        $query = "SELECT * FROM cuti WHERE id_user='$idku'";   
                      
                        $item = mysqli_query($conn,$query);
                        while($items = mysqli_fetch_array($item)){
                    ?>
                      <?php if($items['status']=="menunggu"){ ?>
                    <tr>
                        <td><?=$items['id_cuti'];?></td>
                        <td><?=$items['nama'];?></td>
                        <td><?=$items['tujuan'];?></td>
                        ...
                        <td><?=$items['selesaicuti'];?></td>
                         ...
                         <td>
                           ...
                           <a href="perbaruicuti.php?id_cuti=<?=$items['id_cuti']?>"><button class="btn btn-info "><i class="fa fa-edit "></i></button></a>
                      <a href="hapuscuti.php?id_cuti=<?=$items['id_cuti']?>"><button class="btn btn-danger "><i class="fa fa-trash-o "></i></button></a>
                    </td>
                      ...
                      <?php  }elseif($items['status']=="Di tolak"){ ?>
                    <tr>
                        <td><?=$items['id_cuti'];?></td>
                        <td><?=$items['nama'];?></td>
                        <td><?=$items['tujuan'];?></td>
                    ...
                    <a href="print.php?id_cuti=<?=$items['id_cuti']?>"><button class="btn btn-success "><i class="fa fa-print "></i></button></a>
                      <a href="hapuscuti.php?id_cuti=<?=$items['id_cuti']?>"><button class="btn btn-danger "><i class="fa fa-trash-o "></i></button></a>
                    </td>
