...
<body>
<form method="post" action="updategrafik.php?id_jabatan=<?= $row['id'];?>" enctype="multipart/form-data">
<tr><td>Total</td><br><br><td>:</td><td><input type="text" value="<?php echo $row['total'];?>" name="total" required></td>
<br><br>
<td>Jabatan</td><br><br><td></td><td><input type="text" value="<?php echo $row['jabatan'];?>" name="jabatan"  required></td></tr> 
</table>
<br><br>
