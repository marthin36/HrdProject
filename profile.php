...
<body>
    ...
    $nidn=$query2['nidn'];
    $agama=$query2['agama'];
    $tempat=$query2['tempat_lahir'];
    $ktp=$query2['no_ktp'];
    $sk=$query2['no_sk'];
    $masuk=$query2['tgl_masuk'];
    $kerja=$query2['masa_kerja'];
          ...
          <div class="col-lg-12">
            <div class="row content-panel">
              ...
              <div class="col-md-4 profile-text">
                <h3><?php echo $nama;?></h3>
                <h6><?php echo $jabatans;?></h6>
                <p><span class="fa fa-info"></span> Perbarui Data Jika Data yang dimasukkan masih belum benar.</p>
                <br><br><br>
              ...
              <div class="col-md-4 centered">
                ...
                <img src="admin/image/profil/<?php
                echo $query2['pas_photo']; ?>" width="160px;" style="border: 0px;border-color: black;padding-top: 0px;" class="img-circle"/> 
                              ...
                              <table border="0" width="400" align="center" style="font-size:20px">
                                 ...
                                 <tr>
                                   ...
                                   <tr>
                                    <td>NIDN </td>
                                    <td>:</td>
                                    <td> <p><?php echo $nidn  ?></p></td>
                                </tr>
                                   <tr>
                                    <td>Agama </td>
                                    <td>:</td>
                                    <td> <p><?php echo $agama  ?></p></td>
                                </tr>
                                   <tr>
                                    <td>Tempat Lahir </td>
                                    <td>:</td>
                                    <td> <p><?php echo $tempat  ?></p></td>
                                </tr>
                                   <tr>
                                    <td>KTP</td>
                                    <td>:</td>
                                    <td> <p><?php echo $ktp  ?></p></td>
                                </tr>
                                   <tr>
                                    <td>No SK Kepangkatan </td>
                                    <td>:</td>
                                    <td> <p><?php echo $sk  ?></p></td>
                                </tr>
                                 <tr>
                                    <td>Tanggal Masuk </td>
                                    <td>:</td>
                                    <td> <p><?php echo $masuk  ?></p></td>
                                </tr>
                                 <tr>
                                    <td>Kerja </td>
                                    <td>:</td>
                                    <td> <p><?php echo $kerja  ?></p></td>
                                </tr>
                            </table>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="number" name ="nip" value="<?php echo $query2['nip'] ?>" class="form-control" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">NIDN</label>
                            <div class="col-lg-6">
                              <input type="number" name ="nidn" value="<?php echo $query2['nidn'] ?>" class="form-control" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Agama</label>
                            <div class="col-lg-6">
                              <input type="text" name ="agama" value="<?php echo $query2['agama'] ?>" class="form-control" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Tempat Lahir</label>
                            <div class="col-lg-6">
                              <input type="text" name ="nip" value="<?php echo $query2['tempat_lahir'] ?>" class="form-control" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">KTP</label>
                            <div class="col-lg-6">
                              <input type="number" name ="ktp" value="<?php echo $query2['no_ktp'] ?>" class="form-control" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">No SK</label>
                            <div class="col-lg-6">
                              <input type="number" name ="sk" value="<?php echo $query2['no_sk'] ?>" class="form-control" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Tanggal Masuk</label>
                            <div class="col-lg-6">
                              <input type="date" name ="masuk" value="<?php echo $query2['tgl_masuk'] ?>" class="form-control" required />
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Kerja</label>
                            <div class="col-lg-6">
                              <input type="text" name ="kerja" value="<?php echo $query2['masa_kerja'] ?>" class="form-control" required />
                            </div>
                          </div>
                            <div class="form-group">
