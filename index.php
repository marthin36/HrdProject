        ...
        <div class="row">
          <div class="col-lg-9 main-chart">
            <!--CUSTOM CHART START -->
                       ...
                       <div class="alert alert-info fade in m-b-15alert alert-info fade in m-b-15">
                              <strong>
                                <i class="fa-lg fa fa-check text-info">

                                </i>
                           Layanan Dokumen dapat digunakan jika admin memerlukan dokumen pengguna
                    ...
                    <body>
                         <table align="center" border="1" width:10px; class="table table-bordered table-striped table-condensed" ><tr>
                            ...
                            <th>Date</th> -->
                                   	...
                                   	<?php 
						$query = "SELECT * FROM pengumuman ORDER BY id_pengumuman DESC LIMIT 5";	
						$item = mysqli_query($conn,$query);
						while($items = mysqli_fetch_array($item)){
					?>
                                            <tr>
                            <td width="4px"><a href=" detailpengumumanuser.php?id_pengumuman=<?=$items['id_pengumuman']?>"><?= $items["judul"]; ?></a></td>
