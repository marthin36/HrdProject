<?php require_once("conn.php"); 
  session_start();
    ...
    $show = mysqli_query($conn, "SELECT * FROM cuti WHERE id_cuti='$idCuti'");
      
  if(mysqli_num_rows($show)==0){
    // echo '<script>window.history.back()</script>';
  }else{
    $cutis = mysqli_fetch_array($show);
      }
     $textarea= $cutis['alasan'];
    //   $mulai= $cutis['mulaicuti'];
...
<body>
    ...
    $tujuan=$query2['tujuan'];
    $alasan=$query2['alasan'];
    $mulai=$query2['mulaicuti'];
    $selesai =$query2['selesaicuti'];
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel"  style="height:580px">
              <a href="tablecuti.php" ><button  class="btn btn-danger btn-lg">Batal</button></a>
              <h4 class="mb"><i class="fa fa-angle-right"></i> Tambah Pengumuman</h4>
              <form class="form-horizontal style-form" method="post" action="perbaruicutiproses.php?id_cuti=<?=$idCuti?>" enctype="multipart/form-data">
                <div class="form-group">
               
                  <div class="col-sm-10">
                    <input type="hidden" name="nama" value="<?= $cutis['nama']?>" class="form-control">
                  </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="hidden" name="status" value="<?= $cutis['status']?>" class="form-control">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tujuan" value="<?= $cutis['tujuan']?>" class="form-control">
                  </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="alasan"  class="form-control" ><?php echo $textarea; ?> </textarea>
                  </div>
               </div>
               <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Mulai</label>
                  <div class="col-sm-10">
                    <input type="text" name="mulai" value="<?= $cutis['mulaicuti']?>" class="form-control">
                  </div>
                  
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Selesai</label>
                  <div class="col-sm-10">
                    <input type="text" name="selesai" value="<?= $cutis['selesaicuti']?>" class="form-control">
                  </div>
