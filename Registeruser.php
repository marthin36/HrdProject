            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" action="registeruserproses.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="radio" class="" name="jenis" value="Pria" width="20px"> Pria
                    <input type="radio" class="" name="jenis" value="Wanita"> Wanita
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control"  type="text" placeholder="Disabled input here..." name="notelp" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Email</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="email" placeholder="placeholder">
                  </div>
                </div>
                <div class="form-group">
